...
test("#12417 Claude pin stays a valid version string", () => {
  assert.equal(typeof canonical.CLAUDE_CODE_CLIENT_VERSION, "string");
  assert.ok(canonical.CLAUDE_CODE_CLIENT_VERSION.length > 0);
});
